...
<body>
	...
	<!-- 検索フォーム -->
	<form action="SearchThread" method="get" onsubmit="return check_blank(this)">
		<input type="text" name="textbox" class="textt"> <input
			type="submit" value="検索" class="enniu1">
		<!-- スレッド一覧 -->
