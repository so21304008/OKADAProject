...
<body>
	<form action="servlet" method="post">
		<div class="bg"></div>
		<div class="content">
			<div class='logo'>new User</div>
			user name:<input class="inputbox" type="text" name="username"
				placeholder="Please input Username" id="name" /> <br /> password:<input
				class="inputbox" type="password" name="pwd"
				placeholder="Please input Password" id="password" /></br>password again:<input
				class="inputbox" type="password" name="pwd"
				placeholder="Please input Password" id="password" /> <br /> <input
				type="submit" class="btn" value='registered' onclick="loginFn()" />
		</div>
